...
# Load existing data
with open("/Users/masa/Projects/Epstein/data/metadata/enriched_entity_data.json") as f:
    data = json.load(f)
...
prince_andrew = {
    ...
    "name": "Prince Andrew",
    "name_variations": ["Prince Andrew", "Prince Andrew, Duke of York", "Andrew, Duke of York"],
    "biographical_data": {
        "full_legal_name": {
    ...
    "archive_metadata": {"appears_in_sources": ["black_book", "flight_logs"], "total_flights": 1},
    "research_metadata": {
...
leslie_wexner = {
    ...
    "name": "Leslie Wexner",
    "name_variations": ["Leslie Wexner", "Les Wexner", "Leslie Herbert Wexner"],
    "biographical_data": {
        "full_legal_name": {
...
donald_trump = {
    ...
    "name": "Donald Trump",
    "name_variations": ["Donald Trump", "Donald J. Trump", "Donald John Trump"],
    "biographical_data": {
        "full_legal_name": {
...
print("✓ Added 3 entities: Prince Andrew, Leslie Wexner, Donald Trump")
