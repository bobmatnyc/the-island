...
class DocumentExtractor:
    ...
    DOCUMENTS = [
        {"id": 1, "type": "Email", "pages": range(1, 6), "subject": "RE: Epstein", "category": "emails"},
        {"id": 2, "type": "Email", "pages": range(6, 9), "subject": "FW: Confidential", "category": "emails"},
        {"id": 3, "type": "Letter", "pages": range(9, 11), "subject": "Flight logs letter", "category": "legal"},
        {"id": 4, "type": "Invoice", "pages": range(11, 16), "subject": "Flight service invoices", "category": "records"},
        {"id": 5, "type": "Subpoena", "pages": range(16, 18), "subject": "Flight logs subpoena", "category": "legal"},
        {"id": 6, "type": "Report", "pages": range(18, 20), "subject": "DAVID Summary - Criminal database", "category": "records"},
        {"id": 7, "type": "Subpoena", "pages": [20], "subject": "Investigation assignment", "category": "legal"},
        {"id": 8, "type": "Note", "pages": [21], "subject": "Address location", "category": "notes"},
        {"id": 9, "type": "Report", "pages": range(22, 42), "subject": "FACTS Report - Background check", "category": "records"},
        {"id": 10, "type": "Letter", "pages": range(42, 46), "subject": "Legal correspondence", "category": "legal"},
        {"id": 11, "type": "Memo", "pages": range(46, 55), "subject": "State Attorney memo", "category": "legal"},
        {"id": 12, "type": "Directions", "pages": [55], "subject": "Driving directions", "category": "notes"},
        {"id": 13, "type": "Subpoena", "pages": [56], "subject": "Legal subpoena", "category": "legal"},
        {"id": 14, "type": "Memo", "pages": [57], "subject": "State Attorney document", "category": "legal"},
        {"id": 15, "type": "Subpoena", "pages": range(58, 60), "subject": "Legal subpoena", "category": "legal"},
        {"id": 16, "type": "Memo", "pages": range(60, 69), "subject": "Impeachment Material", "category": "legal"},
        {"id": 17, "type": "Email", "pages": range(69, 88), "subject": "RE: Meeting with Epstein's attorneys", "category": "emails"},
    ]
    ...
    def _create_filename(self, doc_id: int, doc_type: str, subject: str, date: Optional[str]) -> str:
    ...
    def extract_document(self, doc_def: Dict) -> Tuple[str, str, DocumentMetadata]:
        ...
        filename = self._create_filename(
            doc_id, doc_type,
            metadata.subject or doc_def['subject'],
            metadata.date
        )
    ...
    def extract_all(self) -> Dict:
        ...
        for doc_def in self.DOCUMENTS:
            try:
                ...
                error_msg = f"Error processing document {doc_def['id']}: {str(e)}"
