...
def link_emails_to_pdfs(
    email_index: dict[str, dict[str, Any]], pdf_index: dict[str, dict[str, Any]]
    ...
    for _email_id, email_data in email_index.items():
...
def build_unified_index() -> dict[str, Any]:
    ...
    return {"generated": datetime.now().isoformat(), "statistics": stats, "documents": unified}
...
def save_unified_index(index: dict[str, Any]) -> None:
    ...
    compact = {"generated": index["generated"], "statistics": index["statistics"]}
