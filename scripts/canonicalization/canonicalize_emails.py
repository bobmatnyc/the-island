...
EMAILS = [
    {
        ...
        "participants": [
            {
                "name": "Barbara Burns",
                "email": "BBurns@sa15.state.fl.us",
                "role": "sender",
                "affiliations": ["State Attorney's Office"],
            },
            {
                "name": "Jack Goldberger",
                "email": "unknown",
                "role": "recipient",
                "affiliations": ["Defense attorney for Jeffrey Epstein"],
            },
            {
    ...
    },
    {
        ...
        "participants": [
            ...
            {"name": "Michael McAuliffe", "email": "unknown", "role": "recipient"},
            {
                ...
                "email": "AnnMarie.Villafana@usdoj.gov",
                "role": "mentioned",
                "affiliations": ["AUSA"],
            },
        ...
        "participants": [
            {
                ...
                "email": "robiejennag@icloud.com",
                "role": "sender",
                "aliases": ["Jenna", "Jane Doe 102"],
            },
            {
                "name": "Jason R. Richards",
                "email": "Jason.Richards2@ic.fbi.gov",
                "role": "recipient",
                "affiliations": ["FBI"],
            },
    ...
    },
    {
        ...
        "participants": [
            ...
            {
                "name": "Christina Pyror",
                "email": "christina.pyror@ic.fbi.gov",
                "role": "recipient",
                "affiliations": ["FBI Sydney Consulate"],
            },
            {"name": "Jeffrey Epstein", "email": "unknown", "role": "mentioned"},
        ],
    },
...
def generate_statistics():
    ...
    stats["participant_list"] = sorted(participants_set)
