...
class KnowledgeGraphRAG:
    ...
    def get_documents_connecting_entities(
        ...
        if semantic_query:
            return self._rank_by_semantic_similarity(
                list(common_docs),
                semantic_query,
                limit
            )
        ...
        return self._rank_by_entity_mentions(
            list(common_docs),
            entities,
            entity_to_docs,
            limit
...
def main():
    ...
    if args.path:
        ...
        results = kg_rag.temporal_entity_query(
            args.temporal,
            start_date,
            end_date,
            args.limit
