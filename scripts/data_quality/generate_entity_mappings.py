...
from normalize_entity_names import NAME_DISAMBIGUATIONS, KNOWN_ENTITY_MAPPINGS
...
def generate_mappings():
    ...
    for line in lines:
        if "NAME NORMALIZATIONS APPLIED" in line:
            ...
            continue
        elif in_normalization_section and line.startswith("ENTITY MERGE"):
            break
        elif in_normalization_section and "→" in line:
            line = line.strip()
    ...
    for entity in entities_data['entities']:
        ...
        if 'merged_from' in entity and entity['merged_from']:
    ...
    for raw_name in raw_names:
        ...
        if canonical != raw_name:
            ...
            if ws_normalized != raw_name and ws_normalized != canonical:
