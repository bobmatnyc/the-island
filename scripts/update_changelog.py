...
"""
    ...
    def release_version(self, version: str, date: Optional[str] = None) -> None:
        """
...
{new_version_header}"""
    ...
    def add_entry(self, category: str, entry: str, version: str = "Unreleased") -> None:
        """
        ...
        category_match = re.search(category_pattern, section_content, re.DOTALL)
        ...
        updated_section = re.sub(category_pattern, new_category, section_content, count=1)
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("  python update_changelog.py add Added 'New OCR pipeline'")
