...
class CaseDownloader:
    ...
    def _get_case_by_id(self, case_id: str) -> Optional[Dict]:
        ...
        for category in ['criminal_cases', 'civil_individual_cases',
                        'bank_settlement_cases', 'estate_claims']:
    ...
    def download_courtlistener_case(self, case: Dict) -> bool:
        ...
        if self.dry_run:
            print(f"  [DRY RUN] Would download from CourtListener")
            return True
        ...
        print(f"  ℹ See download_instructions in cases_index.json")
    ...
    def download_archive_org_case(self, case_id: str = "house_oversight_nov2025") -> bool:
        ...
        print(f"  Case: House Oversight Committee Release (67,144 PDFs)")
        print(f"  URL: https://archive.org/details/epstein-pdf")
        print()
        print(f"  Option 1: Download using Archive.org's 'Download Options'")
        print(f"    - Visit the URL above")
        print(f"    - Click 'Download Options' on right side")
        print(f"    - Select 'Torrent' or 'Show All' for individual files")
        print()
        print(f"  Option 2: Use internetarchive CLI tool")
        print(f"    pip install internetarchive")
        print(f"    ia download epstein-pdf")
        print()
    ...
    def download_case(self, case_id: str) -> bool:
        ...
        if not case.get('download_recommended', False):
            print(f"  ⚠ Download not recommended for this case")
        ...
        elif 'archive.org' in docs_url:
            return self.download_archive_org_case(case_id)
        else:
            print(f"  ℹ Manual download required")
            print(f"  URL: {docs_url}")
            return False
