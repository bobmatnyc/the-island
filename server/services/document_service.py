...
class DocumentService:
    ...
    def search_documents(
        ...
        all_types = set(doc.get("type", "unknown") for doc in self.documents)
        all_classifications = set(doc.get("classification", "unknown") for doc in self.documents)
        all_sources = set(doc.get("source", "unknown") for doc in self.documents)
        ...
        return {
            ...
            "facets": {
                ...
                "classifications": sorted(list(all_classifications)),
    ...
    def get_documents_by_entity(self, entity_name: str) -> Dict:
        ...
        matching_docs = [
            ...
            if doc.get("path") in doc_paths or
               entity_name in doc.get("entities_mentioned", [])
        ]
